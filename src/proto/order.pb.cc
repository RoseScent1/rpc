...
constexpr valResponse::valResponse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : val_(0)
  , res_info_(0){}
struct valResponseDefaultTypeInternal {
  constexpr valResponseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~valResponseDefaultTypeInternal() {}
  union {
    valResponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT valResponseDefaultTypeInternal _valResponse_default_instance_;
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::sumRequest, a_),
  PROTOBUF_FIELD_OFFSET(::sumRequest, b_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::valResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::valResponse, val_),
  PROTOBUF_FIELD_OFFSET(::valResponse, res_info_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::makeOrderRequest)},
  { 8, -1, -1, sizeof(::makeOrderResponse)},
  { 17, -1, -1, sizeof(::sumRequest)},
  { 25, -1, -1, sizeof(::valResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_valResponse_default_instance_),
};
...
const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001(\005\022\t\n\001b\030\002 \001(\005\",\n\013valResponse\022\013\n\003val\030\001 \001"
  "(\005\022\020\n\010res_info\030\002 \001(\0052b\n\005Order\0222\n\tmakeOrd"
  "er\022\021.makeOrderRequest\032\022.makeOrderRespons"
  "e\022%\n\010sumOrder\022\013.sumRequest\032\014.valResponse"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_order_2eproto = {
  false, false, 333, descriptor_table_protodef_order_2eproto, "order.proto", 
...
class valResponse::_Internal {
 public:
};

valResponse::valResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:valResponse)
}
valResponse::valResponse(const valResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&val_, &from.val_,
    static_cast<size_t>(reinterpret_cast<char*>(&res_info_) -
    reinterpret_cast<char*>(&val_)) + sizeof(res_info_));
  // @@protoc_insertion_point(copy_constructor:valResponse)
}

inline void valResponse::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&val_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&res_info_) -
    reinterpret_cast<char*>(&val_)) + sizeof(res_info_));
}

valResponse::~valResponse() {
  // @@protoc_insertion_point(destructor:valResponse)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void valResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void valResponse::ArenaDtor(void* object) {
  valResponse* _this = reinterpret_cast< valResponse* >(object);
  (void)_this;
}
void valResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void valResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void valResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:valResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&val_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&res_info_) -
      reinterpret_cast<char*>(&val_)) + sizeof(res_info_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* valResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          res_info_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* valResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:valResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // int32 res_info = 2;
  if (this->_internal_res_info() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_res_info(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:valResponse)
  return target;
}

size_t valResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:valResponse)
  size_t total_size = 0;
  ...
  // int32 res_info = 2;
  if (this->_internal_res_info() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_res_info());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData valResponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    valResponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*valResponse::GetClassData() const { return &_class_data_; }

void valResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<valResponse *>(to)->MergeFrom(
      static_cast<const valResponse &>(from));
}


void valResponse::MergeFrom(const valResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:valResponse)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_res_info() != 0) {
    _internal_set_res_info(from._internal_res_info());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void valResponse::CopyFrom(const valResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:valResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool valResponse::IsInitialized() const {
  return true;
}

void valResponse::InternalSwap(valResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(valResponse, res_info_)
      + sizeof(valResponse::res_info_)
      - PROTOBUF_FIELD_OFFSET(valResponse, val_)>(
          reinterpret_cast<char*>(&val_),
          reinterpret_cast<char*>(&other->val_));
}

::PROTOBUF_NAMESPACE_ID::Metadata valResponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_order_2eproto_getter, &descriptor_table_order_2eproto_once,
...
void Order::sumOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::sumRequest*,
                         ::valResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method sumOrder() not implemented.");
  done->Run();
}
    ...
    case 1:
      sumOrder(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::sumRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::valResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& Order::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::valResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void Order_Stub::sumOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
template<> PROTOBUF_NOINLINE ::valResponse* Arena::CreateMaybeMessage< ::valResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::valResponse >(arena);
}
