...
extern valResponseDefaultTypeInternal _valResponse_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::valResponse* Arena::CreateMaybeMessage<::valResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class valResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:valResponse) */ {
 public:
  inline valResponse() : valResponse(nullptr) {}
  ~valResponse() override;
  explicit constexpr valResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  valResponse(const valResponse& from);
  valResponse(valResponse&& from) noexcept
    : valResponse() {
    *this = ::std::move(from);
  }

  inline valResponse& operator=(const valResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline valResponse& operator=(valResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const valResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const valResponse* internal_default_instance() {
    return reinterpret_cast<const valResponse*>(
               &_valResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(valResponse& a, valResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(valResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(valResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  valResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<valResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const valResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const valResponse& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(valResponse* other);
  ...
  protected:
  explicit valResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // int32 res_info = 2;
  void clear_res_info();
  int32_t res_info() const;
  void set_res_info(int32_t value);
  private:
  int32_t _internal_res_info() const;
  void _internal_set_res_info(int32_t value);
  public:

  // @@protoc_insertion_point(class_scope:valResponse)
 private:
  class _Internal;
...
class Order : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void sumOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class Order_Stub : public Order {
 public:
  ...
  void makeOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::makeOrderResponse* response,
                       ::google::protobuf::Closure* done);
  void sumOrder(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::sumRequest* request,
                       ::valResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
// int32 val = 1;
inline void valResponse::clear_val() {
  val_ = 0;
}
inline int32_t valResponse::_internal_val() const {
  return val_;
}
inline int32_t valResponse::val() const {
  // @@protoc_insertion_point(field_get:valResponse.val)
  return _internal_val();
}
inline void valResponse::_internal_set_val(int32_t value) {
  
  val_ = value;
}
inline void valResponse::set_val(int32_t value) {
  _internal_set_val(value);
  // @@protoc_insertion_point(field_set:valResponse.val)
}

// int32 res_info = 2;
inline void valResponse::clear_res_info() {
  res_info_ = 0;
}
inline int32_t valResponse::_internal_res_info() const {
  return res_info_;
}
inline int32_t valResponse::res_info() const {
  // @@protoc_insertion_point(field_get:valResponse.res_info)
  return _internal_res_info();
}
inline void valResponse::_internal_set_res_info(int32_t value) {
  
  res_info_ = value;
}
inline void valResponse::set_res_info(int32_t value) {
  _internal_set_res_info(value);
  // @@protoc_insertion_point(field_set:valResponse.res_info)
}
